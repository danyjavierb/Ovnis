...
var WebSocketServer = require("/home/dany/node_modules/websocket/lib/websocket").server;
var Game = require("/var/www/cp2012/game");
...
HTTPServer.listen(9191, function() { System.log("Listening for connections on port 9999"); });
